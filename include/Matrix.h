...
Matrix imageKMeans(Matrix &,
 int k);//the number of clusters the RGB image should be turned into
 Matrix imageWinnerTakeAll(Matrix &, int k); //As above
 
 Matrix & imageKohonen(Matrix img,//Input image 
 int k,//as above
 double sigma = 2);//sigma for learning rate, defaults to 2
